...
import 'package:gdlibrary_b_1441/invoice/get_total_invoice.dart';
import 'package:gdlibrary_b_1441/invoice/model/custom_row_invoice.dart';
import 'package:gdlibrary_b_1441/invoice/model/product.dart';
import 'package:barcode_widget/barcode_widget.dart';
import 'package:gdlibrary_b_1441/preview_screen.dart';
import 'package:gdlibrary_b_1441/invoice/item_doc.dart';
...
Future<void> createPdf(
  ...
  //mengambil gambar dari asset untuk ditampilkan pada dokumen PDF untuk header dokumen pdf dan logo untuk invoicenya
  final imageLogo =
  ...
  final List<CustomRow> elements = [
    ...
    CustomRow(
      ...
      "",
      "",
      "Rp ${getPPNTotal(soldProducts)}", //memanggil fungsi yang ada pada file get_total_invoice.dart
    ),
    CustomRow(
      "Total",
      "",
      "",
      "Rp ${(double.parse(getSubTotal(soldProducts)) + double.parse(getPPNTotal(soldProducts))).toStringAsFixed(2)}", //memanggil fungsi yang ada pada file get_total_invoice.dart
    ),
  ];
...
pw.Padding contentOfInvoice(pw.Widget table) {
  return pw.Padding(
      ...
      child: pw.Column(children: [
        ...
        table, //Tabel yang sudah diatur tampilannya di dalam file item_doc.dart
        pw.Text("Thanks for your trust, and till the next time."),
        pw.SizedBox(height: 3.h), pw.Text("Kind regards,"),
        pw.SizedBox(height: 3.h), pw.Text("1441"),
      ]));
}
